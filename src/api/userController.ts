...
export async function userRegister(body: API.UserRegisterReq, options?: { [key: string]: any }) {
...
export async function updateUserById(body: API.UserUpdateReq, options?: { [key: string]: any }) {
...
export async function updateSelf(body: API.UserUpdateSelfReq, options?: { [key: string]: any }) {
